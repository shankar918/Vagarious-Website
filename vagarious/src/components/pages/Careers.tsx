...
const CareersPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("❌ Could not submit application. Check console for details.");
    } finally {
  ...
  return (
    <div className="py-5 bg-dark text-white bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950" style={{ minHeight: "100vh" }}>
